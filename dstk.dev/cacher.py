    ...
    def __init__(self, filename):
        ...
        try:
            ...
            try:
                ...
                pass
            logging.info("Loaded run database {} with {} entries".format(filename, len(self.existing_runs)))
        ...
        def exp_runner(*args, **kwargs):
            for exist_args, exist_kwargs, exist_result, *_ in self.existing_runs:
                if (exist_args, exist_kwargs)==(args, kwargs):
                    logging.info("Skipping run {} and returning existing result".format(format_args(args, kwargs)))
            ...
            self.run_count+=1
            logging.info("Running run #{} {}".format(self.run_count, format_args(args, kwargs)))
            ...
            logging.info("Run #{} {} finished after {}sec. Storing in database at position {}.".format(
                self.run_count,
